...
import { getUserReservationsSuccess, getUserReservationsRequest } from '../routes/Profile/modules/profile.js'
...
export const resetPassword = credentials => (dispatch, getState) => {
  ...
  return axios({
    method: 'PUT',
    // TODO: change to apiEndpoints.playven when devise gets under /api namespace
