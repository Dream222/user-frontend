...
const Login = ({show, onChange, handleHide, facebookLogin, isWaitingFacebookResponse,
                login, register, open, error, showModal, hideModal, onSuccess}) => (
    ...
    <Modal.Body>
      <div className='flex-col pal pam-mobile'>
        ...
        <LoginForm onSubmit={ credentials => login({ credentials, onSuccess })}
                   ...
                   facebookLogin={facebookLogin} isWaitingFacebookResponse={isWaitingFacebookResponse} />
